<div class="container">
      ...
      <?php if (isset($addnew_success) && $addnew_success == true): ?>
      ...
      <?php endif?>
        ...
        <div class="row row-centered">
                <div class="col-md-12 title-profile">
                        ...
                        <p>This is is where you can create new users for the Bootcamp Alumni Platform.</p>
...
<div class="edit-form">
	<form class="form-group" method="post" action="">
        ...
        <input name="new_email" type="email" id="inputEmail" class="form-control" required>

        <label for="inputUsername" class="">User name</label>
        <input name="new_username" type="text" id="inputEmail" class="form-control" required>

        <h4>Personal information</h4>

        <label for="inputFirstName" class="">First name</label>
        <input name="new_firstname" type="text" id="inputFirstName" class="form-control" required>

        <label for="inputUsername" class="">Last name</label>
        <input name="new_lastname" type="text" id="inputEmail" class="form-control">
        ...
        <input step="1" min="1" max="249" name="new_currentcountry" type="number" id="inputCurrentCountry" class="form-control" required> .

        <label for="inputCurrentCity" class="">City in which the student lives now</label>
        <input name="new_currentcity" type="text" id="inputCurrentCity" class="form-control">
        ...
        <input step="1" min="1" max="249" name="new_origincountry" type="number" id="inputCountryOrigin" class="form-control" required>

        <label for="inputBirthday" class="">Birthday</label>
        <input name="new_birthday" type="date" id="inputBirthday" class="form-control" required>

        <label for="inputPhone" class="">Phone number</label>
        <input type="new_phone" id="inputPhone" class="form-control">

        <label for="inputLinkedIn" class="">LinkedIn (full LinkedIn URL)</label>
        <input type="new_linkedin" id="inputLinkedIn" class="form-control">

        <label for="inputFacebook" class="">Facebook (full Facebook URL)</label>
        <input type="new_facebook" id="inputFacebook" class="form-control">

        <label for="inputGithub" class="">Github (full Github URL)</label>
        <input type="new_phone" id="inputGithub" class="form-control">      

        <label for="inputPassword" class="">User Password</label>
        <input type="new_password" id="inputPassword" class="form-control" required>

        <button class="btn btn-lg btn-warning btn-block button" type="submit">Add Student</button>      

        </form>

        <a href="<?php echo url::to('admin'); ?>" class="btn btn-primary back-to-admin-button">back to admin</a>
</div>
